        ...
        <form action="{{ route('inventarios.update', $inventario->id) }}" method="POST"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" id="nombre" class="form-control w-full border rounded-md shadow-sm"
                    placeholder="Ingrese el nombre del producto" value="{{ $inventario->nombre }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="cantidad" id="cantidad" class="form-control w-full border rounded-md shadow-sm"
                    placeholder="Ingrese la cantidad disponible" value="{{ $inventario->cantidad }}" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="lugar" id="lugar" class="form-control w-full border rounded-md shadow-sm"
                    placeholder="Ejemplo: Pasillo 3, Estante B" value="{{ $inventario->lugar }}" required>
            </div>
